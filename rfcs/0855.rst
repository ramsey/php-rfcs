...
So add a method called Randomizer::pickArrayKeys(array $array, int
$num): array. It looks incompatible with array_rand(), but you can get
completely consistent results by doing the following:
...
Question: Add Random\Randomizer::pickArrayKeys(array $array, int $num): array
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
