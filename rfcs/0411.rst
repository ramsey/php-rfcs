...
:PHP-RFC: 0411
:Title: Random Functions Throwing Exceptions In PHP 7
...
for failure. It is far too easy for an uninformed programmer to be
...
If ``random_int`` isn't able to capture enough entropy, it will error.
In that case, ``$password`` would be 10 null bytes. Without careful
error checking this could cause severe security issues. This is not
acceptable and this RFC proposes to solve this by making all errors in
these functions into exceptions.
...
This RFC explicitly does not address how exceptions should be thrown
from other core functions. This question will be addressed in a separate
RFC. Focus was given to the particular functions in this RFC due to
their importance to security applications.
...
Question: Should this RFC be accepted for 7.0
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
:Original Authors: Anthony Ferrara ircmaxell@php.net, Aaron Piotrowski aaron@icicle.io
:Original Status: Accepted
:Slug: random-function-exceptions
:Wiki URL: https://wiki.php.net/rfc/random-function-exceptions
