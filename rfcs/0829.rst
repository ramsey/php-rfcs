...
readonly. Furthermore, it will prevent the usage of dynamic properties.
...
Similarly how overriding of readonly properties works, only a readonly
class can extend a readonly parent:
