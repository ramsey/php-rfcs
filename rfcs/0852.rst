...
**Add a deprecation notice for \`is_callable()\` when it receives one of
the deprecated partially supported callables: yes/no**

**Add a deprecation notice for the \`callable\` type when type
verification detects one of the deprecated partially supported
callables: yes/no**
