...
can become "" and vice versa) - that is something this RFC makes
possible, as without this RFC reversing a coercion to boolean will often
not lead back to the original value. These examples illustrate
reversibility and the loss of information:
...
.. code:: php
   ...
   // the deprecation notice of this RFC points out the loss of information
...
Having as little information loss between scalar type coercions as
possible makes them safer to use and more predictable, which is one of
