...
.. code:: php
   ...
   $afterMultiple = $randomizer->pickArrayKeys(['foo' => 'foo', 'bar' => 'bar', 'baz' => 'baz'], 2); // (array) ['bar', 'baz']
   [$afterSingle] = $randomizer->pickArrayKeys(['foo' => 'foo', 'bar' => 'bar', 'baz' => 'baz'], 1); // (string) foo
